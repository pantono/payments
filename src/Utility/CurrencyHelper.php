...
namespace Pantono\Payments\Utility;

class CurrencyHelper
{
    private static array $currency_list = [
    ...
    {
        return self::$currency_list[$code] ? self::$currency_list[$code]['symbol'] : null;
    }

    public static function getName(string $code): ?string
    {
        return self::$currency_list[$code] ? self::$currency_list[$code]['name'] : null;
    }
}
